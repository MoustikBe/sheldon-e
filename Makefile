...
SOURCES     = src/parsing/pars_bin.c src/parsing/pars_cd.c src/parsing/pars_quot.c src/parsing/pars_dolar.c src/parsing/pars_export.c src/parsing/pars_cmd.c src/parsing/pars_syntax.c src/parsing/pars_check.c src/parsing/pars_main.c \
              ...
              src/executer/exec_main.c src/executer/exec_pipe.c src/executer/exec_multi_pipe.c src/executer/exec_main_path.c src/executer/exec_main_utils.c src/executer/exec_pipe_file.c src/executer/exec_pipe_submain.c src/executer/exec_multi_file.c src/executer/exec_multi_process.c \
